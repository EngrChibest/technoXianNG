      ...
      <div className="container-sm" >
          <Grid container sx={{mt: '15%', mx: 'auto'}} data-aos="fade-up">
            ...
            <Grid item xs={12} sm={7} md={7} className='form-margin' data-aos="fade-up">
                <iframe title="Corporate Registration Form" src="https://docs.google.com/forms/d/e/1FAIpQLScfqK9J3ExtPWDjRXugdsqjP4iMQ1g5-IxRy4axYSuNoUYFXQ/viewform?embedded=true" className='form-dimension' frameBorder="0">Loading…</iframe>
            </Grid>
          </Grid>
      </div>
      </LayoutDefault>

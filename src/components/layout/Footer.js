            ...
            <Box>
              <Grid container spacing={3}>
                <Grid item xs={12} sm={4} md={4}>
                  <Link to='/'>
                    <img src={ Logo } width="170" alt="" className="float-righ" style={{marginBottom: '18px'}}/>
                  </Link>
                  <Link to='/'>
                    <p>Home</p>
                  </Link>
                ...
                <Grid item xs={12} sm={8} md={8}>
                  <Grid container spacing={4}>
                    <Grid item md={4} sm={4} xs={12}>
                      <h5>Challenges</h5>
                      <a href='https://www.technoxian.com/event/robosoccer/' target='_blank' rel="noopener noreferrer">
                        <p>ROBOSOCCER</p>
                      </a>
                      <a href='https://www.technoxian.com/event/wrc-bots-combat/' target='_blank' rel="noopener noreferrer">
                        <p>ROBOWAR</p>
                      </a>
                      <a href='https://www.technoxian.com/event/robo-race/' target='_blank' rel="noopener noreferrer">
                        <p>ROBORACE</p>
                      </a>
                      <a href='https://www.technoxian.com/event/fastest-line-follower/' target='_blank' rel="noopener noreferrer">
                        <p>LINE FOLLOWER</p>
                      </a>
                      <a href='https://www.technoxian.com/event/water-rocket/' target='_blank' rel="noopener noreferrer">
                        <p>WATER ROCKET</p>
                      </a>
                    </Grid>
                    <Grid item md={4} sm={4} xs={12}>
